...
*** Test Cases ***
Verify checkout with empty cart with standard user
...
Fill postal-code contain letter with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
...
Fill valid info at Checkout page with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
...
Not fill firstname at Checkout page with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
...
Not fill lastname at Checkout page with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
...
Not fill postal-code at Checkout page with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
...
Only fill firstname at Checkout page with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
...
Only fill lastname at Checkout page with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
...
Only fill postal-code at Checkout page with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
...
Cancel checkout process at checkout overview with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
...
Cancel checkout process at checkout information with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
...
Buy each item and checkout for each item with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
...
Buy all items then checkout for all items with standard user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with standard user
