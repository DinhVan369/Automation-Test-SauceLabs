...
*** Test Cases ***
Verify checkout with empty cart with visual user
...
Fill postal-code contain letter with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
...
Fill valid info at Checkout page with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
...
Not fill firstname at Checkout page with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
...
Not fill lastname at Checkout page with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
...
Not fill postal-code at Checkout page with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
...
Only fill firstname at Checkout page with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
...
Only fill lastname at Checkout page with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
...
Only fill postal-code at Checkout page with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
...
Cancel checkout process at checkout overview with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
...
Cancel checkout process at checkout information with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
...
Buy each item and checkout for each item with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
...
Buy all items then checkout for all items with visual user
    Open Browser to Login
    Maximize Browser Window
    # Login
    Login with visual user
